...
4. Then run the command ```node server.js``` or ```npm start``` to run the software.
...
![image](https://user-images.githubusercontent.com/104656042/185333394-061538e7-491b-47de-b383-20d292083063.png)



## Link to video demo
https://youtu.be/NIsJ4l4yJUg

## Link to repository/code
https://github.com/sallaball/Employee-Tracker
